...
subtest "test subtest1" => sub {
    ...
    subtest "subtest in subtest1" => sub {
        is(Add::add(1, 2), 3, "in subtest 1 subtest1 test 1");
        is(Add::add(2, 2), 4, "in subtest 1 subtest1 test 2");
    };
};
...
subtest "test subtest2" => sub {
    ...
    subtest "subtest in subtest2" => sub {
        is(Add::add(1, 2), 3, "in subtest 2 subtest 1 test 1");
        is(Add::add(2, 2), 5, "in subtest 2 subtest 1 test 2, will fail");
    };
};
